...
const KANA_API_BASE_URL = process.env.REACT_APP_MY_KANA_API_URL || 'http://localhost:3001/api/kana';
console.log('KANA_API_BASE_URL (using MY_KANA_API_URL):', KANA_API_BASE_URL);
